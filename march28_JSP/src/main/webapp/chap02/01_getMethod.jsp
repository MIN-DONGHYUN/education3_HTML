...
<head>
<meta charset="UTF-8">
<title>form 태그의 GET 방식으로 데이터 전송하기</title>
...
<body>
	...
	<form name="registerFrm" action="<%= ctxPath %>/01_getMethod.do" method="get">   <!-- method 에 get을 쓰면 전송되어질 값이 보이고 post 를 쓰면 전송되어질 값이 안보인다. (method 생략시 같다.) -->
